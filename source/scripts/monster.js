define(['map', 'screen', 'noise', 'pathfinding', 'light'], function(map, screen, noise, pathfinding, light){
	...
	//DO UKOŃCZENIA PO ZAIMPLEMENTOWANIU PRZEDMIOTÓW I WSZYSTKICH TYPÓW PÓL I INNYCH FICZURSÓW
	class Monster{
		...
		init(){
			...
			function startPosition(){
				...
				if(map.cells[level][x][y].entity != null || map.cells[level][x][y].isVisible == true){
					start();
				}
