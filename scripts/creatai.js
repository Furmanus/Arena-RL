  ...
  define(['map', 'screen', 'pathfinding', 'combat'], function(map, screen, pathfinding, combat){
     ...
     function nextStep(monster){
         ...
         function examineFov(monster){
             ...
             for(var i=0; i<monster.currentFov.length; i++){
                 ...
                 if(examinedCell.entity !== null && examinedCell.entity !== monster && monster.checkIfHostile(examinedCell.entity) === true){
                    ...
                    //hostile has been found, so we can now reset lookingForHostile flag                    
                     monster.lookingForHostile = false;
                 }
             ...
             //if monster inventory is already full, or monster is looking for hostile, he will not pick up any additional items
             
             if(cellsOfInterest.length > 0 && (monster.inventory.length > 12 || monster.lookingForHostile === true)){
             ...
             */
             function filterFovCells(type){
                ...
                for(var i=0; i<cellsOfInterest.length; ){
         ...
         function examineGroundItems(monster, cellsOfInterest){
             ...
             if(monster.lookingForHostile === true){
